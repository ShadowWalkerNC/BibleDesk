...
export function EncouragePanel({ initialQuery = '' }: { initialQuery?: string }) {
  const router = useRouter();
  const [selectedCategory, setSelectedCategory] = useState<string>('all');
  // C01: seeded from ?q= for slash-command deep links (e.g. /encourage anxiety).
