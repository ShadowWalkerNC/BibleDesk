export interface DailyDevotionalItem {
  reference: string;
  text: string;
  translation: string;
  theme: string;
...
export const DAILY_DEVOTIONALS: DailyDevotionalItem[] = [
  {
    ...
    prayer_focus: 'Surrendering anxieties and resting in God’s peace.',
  },
  {
    ...
    prayer_focus: 'Patience and divine renewal of energy.',
  },
  {
    ...
    prayer_focus: 'Trusting God’s sovereign plan through difficulty.',
  },
  {
    ...
    prayer_focus: 'Direction in daily decisions and obedience.',
  },
  {
    ...
    prayer_focus: 'Gratitude for morning mercies and forgiveness.',
  },
  {
    ...
    prayer_focus: 'Holy courage and bold witness.',
  },
  {
    ...
    prayer_focus: 'Spiritual rest and restoration.',
  },
  {
    ...
    prayer_focus: 'Deepening faith and enduring conviction.',
  },
  {
    ...
    prayer_focus: 'Living with joyful gratitude for grace.',
  },
  {
    ...
    prayer_focus: 'Daily Scripture reading and obedience.',
  },
];
